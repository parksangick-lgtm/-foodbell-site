...
# 긴 변(px), JPEG 품질
# 2026-09-10: 실제 사진(잔디·그림자 등 어려운 부분)으로 눈으로 비교해보고
# 어색해 보이기 직전까지 한 단계 더 줄임.
HERO = (1600, 68)  # 첫 화면 배경 - 화면 전체를 덮으므로 크기는 유지, 화질만 낮춤
ALBUM = (950, 65)  # 앨범 - 작은 정사각 썸네일 + 클릭 시 확대
NORMAL = (1100, 66)  # 갤러리 / 메뉴 사진
