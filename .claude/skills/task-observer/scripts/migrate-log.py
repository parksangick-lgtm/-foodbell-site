...
def _force_utf8_output():
    """Never assume the console is UTF-8 — see validate-skill-bundle.py.

    This script converts a log in place; if a print of a progress line dies on
    a CJK console code page, the migration stops half-done and the traceback
    is the only record of how far it got.
    """
    import sys
    for stream in (sys.stdout, sys.stderr):
        try:
